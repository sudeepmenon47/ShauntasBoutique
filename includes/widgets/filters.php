...
<form action="search.php" method="post">
    ...
    <input type="text" name="min_price" class="price-range text-center" placeholder="Min ₹" value="<?=$min_price;?>"> To
    <input type="text" name="max_price" class="price-range text-center" placeholder="Max ₹" value="<?=$max_price;?>"><br><br>
